const ROUTE = "M1140 776 1033 591 1210 480 1064 229 1138 183";

/** Decorative activity indicator, not measured packet positions or replay progress. */
export function HeroTopology({ active = false }: { active?: boolean }) {
  return <div className="hero-topology" data-active={active} aria-hidden="true">
    <svg viewBox="0 0 1440 900" fill="none" preserveAspectRatio="xMidYMid slice" focusable="false">
      ...
      <g className="topology-links" transform="rotate(-32 1080 450)">
        ...
        {active && <g className="topology-flow" strokeWidth="3">
          <path d="M540 170H630V410H830V780H1080V1030" pathLength={100} strokeDasharray="1 24" />
          <path d="M790 420H940V580H1210V790H1510" pathLength={100} strokeDasharray="1 24" />
          <path d="M1030 940V720H1370V470H1510" pathLength={100} strokeDasharray="1 24" />
        </g>}
