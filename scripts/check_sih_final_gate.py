    ...
    return {
        ...
        "ps_evidence_map": [
            ...
            {"requirement": "DGA from published algorithm samples", "status": "campaign_demo_pass_domain_ml_gap",
             "proof": "output/sih_gate2_dga_audit.json; output/sih_chrmor_holdout_audit.json; output/sih_ctu_dga_holdout_audit.json"},
        ...
        "limitations": [
            ...
            "Published-domain generalization remains below gate: the CTU-trained candidate reached 68.8% recall / 0.1% FPR on a frozen 2,000-positive/2,000-negative upload holdout, below the unchanged 70% recall requirement; it was not deployed. Campaign positives require resolver context, and the Chrmor control uses simulated outcomes.",
